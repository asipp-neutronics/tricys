...
class SimulationUI:
    ...
    def create_widgets(self):
        ...
        tk.Entry(self.root, textvariable=self.sim_step_size_var, state='readonly').grid(row=5, column=1, padx=5, pady=5)
    ...
    def run_simulation(self):
        ...
        try:
            ...
            temp_dir = "D:/FusionSimulationProgram/FFCAS_v0_FusionFuelCycleAnalysisSystem/data"
            output_csv_files = run_parameter_sweep(package_path, model_name, param_A_values, param_B_sweep, stop_time, sim_step_size, temp_dir)
            result_path = combine_simulation_results(param_A_values, param_B_sweep, temp_dir, output_csv_files)

            # Plot startup tritium inventory
            plot_path = plot_startup_inventory(result_path, param_A_name, param_B_name)
