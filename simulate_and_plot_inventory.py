...
class SimulationUI:
    ...
    def create_widgets(self):
        ...
        tk.Entry(self.root, textvariable=self.sim_step_size_var,
                 state='readonly').grid(row=5, column=1, padx=5, pady=5)  # 只读
    ...
    def run_simulation(self):
        try:
            ...
            plot_path = self.plot_startup_inventory(
    ...
    def plot_startup_inventory(self, csv_path, param_A_name, param_B_name):
        ...
        param_columns = [
            col for col in param_columns if col != 'time']  # 排除 time 列
        ...
        for col in param_columns:
            ...
            param_A_values[param_A_val].append(
                (param_B_val, startup_inventory))
        ...
        for i, (param_A_val, data) in enumerate(param_A_values.items()):
            ...
            # 绘制折线
            plt.plot(param_B_vals, startup_inventories, marker='o',
                     label=f"{param_A_name}={param_A_val:.3f}", color=colors[i], linewidth=1.5)
